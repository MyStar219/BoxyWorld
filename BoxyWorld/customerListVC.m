...
- (void)viewDidLoad {
    ...
    */
    [tableCustomaerList registerNib:[UINib nibWithNibName:@"customerListCell" bundle:nil]forCellReuseIdentifier:@"customerListCell"];
        ...
        if([status isEqualToString:@"1"]) {
            ...
            if([temp count] > 0)
            {
                for(int i=0;i<[temp count];i++)
                {
                    ...
                    NSString *Ccountry = ([[[temp objectAtIndex:i]objectForKey:@"foreign_country_id"]isKindOfClass:[NSNull class]] || [[temp objectAtIndex:i]objectForKey:@"foreign_country_id"] == nil)?@"":[[temp objectAtIndex:i]objectForKey:@"foreign_country_id"];
                    ...
                    [customer1 setObject:fname forKey:@"fname"];
                    [customer1 setObject:lastname forKey:@"lastname"];
                    ...
                    [customer1 setObject:Ccountry forKey:@"Ccountry"];
                    [customer1 setObject:zip forKey:@"zip"];
                    [customer1 setObject:city forKey:@"city"];
                    [customer1 setObject:customerId forKey:@"customerId"];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //customerSelectBtn
    //[cell.customerImg setHidden:YES];
    ...
    if([customerImg isEqualToString:@""] || [customerImg isEqualToString:@"userIcon"] )
    {
   ...
   */
    [cell.customerSelectBtn setImage:[UIImage imageNamed:@"edit"] forState:UIControlStateNormal];
    // cell.customerSelectBtn.layer.borderColor = [UIColor clearColor].CGColor;
    [cell.customerSelectBtn setTintColor:[UIColor whiteColor]];
    //[cell.customerSelectBtn setBackgroundColor:[UIColor colorWithRed:0.12 green:0.67 blue:0.00 alpha:1.0]];
    
    [cell.customerSelectBtn addTarget:self action:@selector(editCustomer:) forControlEvents:UIControlEventTouchUpInside];
    cell.customerSelectBtn.accessibilityLabel = @"edit";
    cell.customerSelectBtn.tag = indexPath.row;
    
    //[cell.customerSelectBtn backgroundImageForState:[UIImage imageNamed:@"edit"]];
